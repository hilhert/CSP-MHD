...
def plot_training_curves(train_losses, test_accs, save_path='.', file_name="training_curves.png", show=True):
    """
    plot the training loss：Loss + Accuracy
    """
    ...
    # Accuracy 
    # test_accs samples every 10 epoches
...
def plot_grokking_analysis(test_accs, gradient_norms, train_losses=None, 
    ...
    """
    plot Grokking analysis：accuracy + gradnorms
    ...
    # left：accuracy curve（label grokking pos）
    ...
    # find accurcy sudden imporved point（从 < 0.9 到 > 0.9）
    grokking_epoch = None
...
def plot_grokking_analysis_f1(test_f1s, gradient_norms, train_losses=None, 
    ...
    """
    polt Grokking analysis：F1 + gradnorm
    """
