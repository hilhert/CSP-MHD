...
def plot_training_curves(train_losses, test_accs, save_path='figures/training_curves.png', show=True):
    """
...
def plot_grokking_analysis(test_accs, gradient_norms, train_losses=None, 
                          save_path='figures/grokking_analysis.png', show=True):
    """
...
def plot_gradient_norm(gradient_norms, save_path='figures/gradient_norm.png', show=True):
    """
